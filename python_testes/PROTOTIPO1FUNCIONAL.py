...
def algoritmo_genetico(populacao_inicial, geracoes):
    ...
    for geracao in range(geracoes):
        ...
        print(f"Melhor fitness na geração {geracao + 1}: {calcular_fitness(melhor_cronograma)}")
...
print("Melhor cronograma encontrado:")
for dia in dias_semana:
    print(dia)
    for horario in horarios:
        print(f"{horario}: {melhor_cronograma[dia][horario]}")
    print()
